<div class="thim-link-login thim-login-popup">
	<?php if ( is_user_logged_in() ): ?>
		...
		<?php if ( !empty( $instance['text_logout'] ) ): ?>
			<a class="logout" href="<?php echo esc_url( wp_logout_url( apply_filters( 'thim_default_logout_redirect', (isset($_SERVER['HTTPS']) ? "https" : "http") . '://' . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] ) ) ); ?>"><?php echo esc_html( $instance['text_logout'] ); ?></a>
		<?php endif; ?>
	<?php else : ?>
		<?php

...
class Thim_Developer_Access extends Thim_Singleton {
	...
	public function enqueue_scripts() {
		wp_register_script( 'thim-developer-access', THIM_CORE_ADMIN_URI . '/assets/js/developer-access.js', array( 'jquery', 'thim-core-clipboard' ), THIM_CORE_VERSION );
	}
	...
	public function box_manage_developer_access() {
		...
		Thim_Template_Helper::template( 'developer-access.php', $args, true );
	}

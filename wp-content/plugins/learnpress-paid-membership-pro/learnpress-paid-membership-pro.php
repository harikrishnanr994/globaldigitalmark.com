...
define( 'LP_ADDON_PMPRO_VER', '2.3.6' );
...
class LP_Addon_PMPRO {
	...
	public function admin_require() {
		require_once __DIR__ . DIRECTORY_SEPARATOR . 'inc' . DIRECTORY_SEPARATOR . 'pmpro-admin' . DIRECTORY_SEPARATOR . 'pmpro-admin.php';
		$this->add_setting();
	}
	...
	private function _init_hooks() {
		...
		add_filter( 'learn_press_external_link_buy_course', array( $this, 'external_link_buy_course' ), 10, 2 );
	}
	...
	public function learn_press_before_course_buttons( $course_id ) {
		if ( ! learn_press_pmpro_user_can_enroll_course( $course_id ) ) {
